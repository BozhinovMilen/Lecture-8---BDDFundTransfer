...
public class FundTransferStepDef {
    ...
    public void ensure_the_fund_transfer_is_complete_with_message(String expectedFundTransferCompleteMessage) {
        String actualFundTransferCompleteMessage = driver.findElement(By.id("message")).getText();
        Assert.assertEquals(actualFundTransferCompleteMessage, expectedFundTransferCompleteMessage, "bug beee");
    }
    ...
    public void ensure_a_transaction_failure_message_is_displayed(String expectedFundTransferFailureMessage) {
        String actualFundTransferFailureMessage = driver.findElement(By.id("message")).getText();
        Assert.assertEquals(actualFundTransferFailureMessage, expectedFundTransferFailureMessage, "bug beee");
    }
}
